...
function initiate2FASetup(userId, userEmail) {
    ...
    const otpauthUrl = `otpauth://totp/SMPMPS:${encodeURIComponent(userEmail)}?secret=${secret}&issuer=SMPMPS&digits=${TOTP_CONFIG.digits}&period=${TOTP_CONFIG.period}`;
...
// Create the TwoFactorService object for default export
const TwoFactorService = {
    initiateSetup: initiate2FASetup,
